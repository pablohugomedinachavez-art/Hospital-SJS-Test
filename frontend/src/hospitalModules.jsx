...
export default function DeviceManagerDashboard() {
  const [activeTab, setActiveTab] = useState('devices');
  const [searchQuery, setSearchQuery] = useState('');
  const [statusFilter, setStatusFilter] = useState('all');

  return (
    <div className="min-h-screen w-full bg-[#080c14] text-slate-100 p-4 sm:p-6 lg:p-8 font-sans antialiased">
      <div className="max-w-7xl mx-auto space-y-6">

        {/* --- Top Navbar Superior --- */}
        <header className="bg-slate-900/80 border border-slate-800/80 rounded-2xl px-6 py-4 flex items-center justify-between shadow-xl backdrop-blur-md">
          <div className="flex items-center gap-3">
            <span className="w-2.5 h-2.5 rounded-full bg-blue-500 animate-pulse" />
            <h2 className="text-sm font-semibold text-slate-200 tracking-wide">Panel General</h2>
          </div>
        ...
        {/* --- Módulo Principal de Gestión --- */}
        <main className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 shadow-2xl space-y-6">
          
          {/* Encabezado + Pestañas (Header Row) */}
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-800/80 pb-6">
            ...
            <div className="flex p-1 bg-slate-950/80 border border-slate-800/80 rounded-xl self-start lg:self-auto">
              {[
          ...
          {/* Barra de Herramientas y Controles (Toolbar) */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            <div className="flex flex-1 items-center gap-3 max-w-xl">
              
              {/* Buscador con Padding Correcto */}
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-950/60 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                />
              </div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-slate-950/60 border border-slate-800 rounded-xl pl-4 pr-10 py-2.5 text-xs text-slate-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all cursor-pointer"
                >
                  <option value="all">Todos los estados</option>
                  <option value="active">Activo</option>
                  <option value="maintenance">Mantenimiento</option>
                </select>
                <Filter className="w-3.5 h-3.5 absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
              </div>
            </div>

            {/* Botón Acción Principal */}
            <button className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-semibold text-xs transition-all shadow-lg shadow-emerald-600/20 active:scale-95">
              <Plus className="w-4 h-4" />
              <span>Nuevo Dispositivo</span>
            </button>
          </div>

          {/* --- Grid de Tarjetas (Device Cards) --- */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pt-2">
            
            {/* Card Ejemplo Corregido */}
            <div className="bg-slate-950/50 border border-slate-800/80 hover:border-slate-700/80 rounded-2xl p-4 flex flex-col justify-between gap-4 transition-all shadow-md hover:shadow-xl group">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="p-2 bg-slate-900 rounded-xl border border-slate-800 text-blue-400 group-hover:scale-105 transition-transform">
                ...
                <div>
                  <h3 className="font-semibold text-slate-100 text-sm tracking-tight">hiuhuh</h3>
                  <p className="text-xs text-slate-400 mt-0.5">PC de Escritorio</p>
                </div>
              </div>

              {/* Meta Data del Dispositivo */}
              <div className="pt-3 border-t border-slate-800/60 flex items-center justify-between text-[11px] text-slate-400">
                <div className="flex items-center gap-1.5 font-mono text-slate-300">
                  ...
                  <span>190.116.50.241</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400 max-w-[100px] truncate">
                  <MapPin className="w-3.5 h-3.5 text-slate-500 shrink-0" />
                  <span className="truncate">asdfsdf</span>
                </div>
              </div>
            </div>
